...
Run `./scripts/build_dmg.sh` to create `AACC-1.3.0-rc.5.dmg` on the desktop. Open it and drag `AACC.app` to Applications. This RC is ad-hoc signed and not notarized; verify the published SHA-256 before using **Open Anyway**.
