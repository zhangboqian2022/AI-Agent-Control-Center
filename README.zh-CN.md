...
[English README](README.md) · [下载 AACC 1.1.0](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.1.0/AACC-1.1.0.dmg) · [发布说明](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.1.0) · [产品设计](docs/product-design.zh-CN.md)
...
下载 [AACC-1.1.0.dmg](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.1.0/AACC-1.1.0.dmg)，打开后把 `AACC.app` 拖入“应用程序”文件夹。
...
4. 点击“开始监控”。只有手工选择或未被静默的运行任务会显示并被检查状态。
5. 将面板拖到固定位置；在设置中选择是否始终置顶，或恢复到桌面右上角。
