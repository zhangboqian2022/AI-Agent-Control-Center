...
[English README](README.md) · [下载 AACC 1.4.5](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.4.5) · [发布说明](docs/release-notes-1.4.5.md) · [产品设计](docs/product-design.zh-CN.md)
...
下载 [AACC-1.4.5.dmg](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.4.5/AACC-1.4.5.dmg)，打开后把 `AACC.app` 拖入“应用程序”文件夹。
...
Windows 主下载文件是 `AACC-1.4.5-Setup.exe`，并配套 `AACC-1.4.5-Setup.exe.sha256`。Windows 1.4.5 的 Setup 资产需在 Windows 机器上构建后补传到该发布；在此之前请使用 [v1.4.4-rc.1 发布](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.4.4-rc.1)的 Windows 资产。
