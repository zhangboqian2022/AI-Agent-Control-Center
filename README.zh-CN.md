...
[English README](README.md) · [下载 AACC 1.4.6-rc.1](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.4.6-rc.1) · [发布说明](docs/release-notes-1.4.6rc1.md) · [产品设计](docs/product-design.zh-CN.md)
...
下载 [AACC-1.4.6-rc.1.dmg](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.4.6-rc.1/AACC-1.4.6-rc.1.dmg)，打开后把 `AACC.app` 拖入“应用程序”文件夹。
...
Windows 主安装包是 `AACC-1.4.5-Setup.exe`，并配套 `AACC-1.4.5-Setup.exe.sha256`。1.4.6-rc.1 尚未发布 Windows 构建：Windows 构建需在 Windows 机器上产出后补传到 [v1.4.6-rc.1 发布](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.4.6-rc.1)。1.4.5 的 Setup 同样需在 Windows 机器上构建后补传到 v1.4.5 发布；在这些资产就绪之前，请使用 [v1.4.4-rc.1 发布](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.4.4-rc.1)的 Windows 资产。
