...
[English README](README.md) · [下载 AACC 1.3.3-rc.1](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.3.3-rc.1/AACC-1.3.3-rc.1.dmg) · [发布说明](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.3.3-rc.1) · [产品设计](docs/product-design.zh-CN.md)
...
下载 [AACC-1.3.3-rc.1.dmg](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.3.3-rc.1/AACC-1.3.3-rc.1.dmg)，打开后把 `AACC.app` 拖入“应用程序”文件夹。
