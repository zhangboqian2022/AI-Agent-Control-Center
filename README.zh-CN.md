...
[English README](README.md) · [下载 AACC 1.2.0](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.2.0/AACC-1.2.0.dmg) · [发布说明](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.2.0) · [产品设计](docs/product-design.zh-CN.md)
...
下载 [AACC-1.2.0.dmg](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.2.0/AACC-1.2.0.dmg)，打开后把 `AACC.app` 拖入“应用程序”文件夹。
