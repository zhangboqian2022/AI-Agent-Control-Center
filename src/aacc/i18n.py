...
CATALOGS: dict[Language, dict[str, str]] = {
    ZH_CN: {
        ...
        "qwen.quota": "Qwen Code 额度",
        "qwen.syncing": "正在同步日常 Chrome 会话…",
        "qwen.login_opening": "同步失败，正在打开登录窗…",
        "qwen.auto_recovering": "会话已过期，正在自动恢复…",
        "qwen.five_hour": "5 小时",
        "qwen.weekly": "7 天",
        "qwen.team_total": "团队",
        "settings.visible_quota_panels": "额度展板",
        "qwen.web_title": "Qwen Code 登录",
        "qwen.web_starting": "正在启动百炼控制台登录页面，请稍候…",
        "qwen.web_need_config": "请先在 config.yaml 中配置 qwen_workspace_url",
        "qwen.web_unauthorized": "Qwen Code 登录已过期，请重新授权",
        "qwen.web_refresh_timeout": "Qwen Code 额度刷新超时",
        "qwen.web_refresh_failed": "Qwen Code 额度刷新失败",
        "qwen.web_parse_failed": "Qwen Code 额度数据解析失败",
        "task.switch": "切换到任务",
        ...
        "settings.select_qwen": "选择监控的 Qwen Code 任务",
        ...
        "settings.opencode_web_login": "登录 OpenCode（同步 滚动 / WEEK / MONTH）",
    ...
    EN_US: {
        ...
        "qwen.quota": "Qwen Code quota",
        "qwen.syncing": "Syncing the daily Chrome session…",
        "qwen.login_opening": "Sync failed; opening the login window…",
        "qwen.auto_recovering": "Session expired; recovering automatically…",
        "qwen.five_hour": "5H",
        "qwen.weekly": "7D",
        "qwen.team_total": "Team",
        "settings.visible_quota_panels": "Quota panels",
        "qwen.web_title": "Qwen Code login",
        "qwen.web_starting": "Starting the Bailian console login page. Please wait…",
        "qwen.web_need_config": "Set qwen_workspace_url in config.yaml first",
        "qwen.web_unauthorized": "Qwen Code sign-in expired. Please authorize again",
        "qwen.web_refresh_timeout": "Qwen Code quota refresh timed out",
        "qwen.web_refresh_failed": "Qwen Code quota refresh failed",
        "qwen.web_parse_failed": "Qwen Code quota data could not be parsed",
        ...
        "settings.select_qwen": "Select Qwen Code tasks to monitor",
        ...
        "settings.opencode_web_login": "Sign in to OpenCode (sync ROLLING / WEEK / MONTH)",
