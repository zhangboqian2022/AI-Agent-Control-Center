...
class QuotaBar(QFrame):
    ...
    def __init__(self) -> None:
        ...
        self.summary_label.setFixedWidth(88)
        ...
        metric_layout.setColumnMinimumWidth(2, 32)
        metric_layout.setColumnMinimumWidth(3, 144)
