...
[中文文档](README.zh-CN.md) · [Download AACC 1.3.2](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.3.2/AACC-1.3.2.dmg) · [Release notes](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/tag/v1.3.2) · [Product design](docs/product-design.md)
...
Download [AACC-1.3.2.dmg](https://github.com/zhangboqian2022/AI-Agent-Control-Center/releases/download/v1.3.2/AACC-1.3.2.dmg), open it, and drag `AACC.app` to Applications.
