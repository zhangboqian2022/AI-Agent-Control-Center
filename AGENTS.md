...
- `codex/codex-dynamic-quota-tray-exit@e0d9450`：Windows Codex 实时额度源
...
- 托盘右键不再触发面板显隐，菜单由主窗口持有避免被回收；托盘“退出 AACC”
  ...
  944 passed、7 skipped，ruff、format、mypy 全绿；hosted 全量运行
  `https://github.com/zhangboqian2022/AI-Agent-Control-Center/actions/runs/30432641773`
...
- 最新 Codex 同步/退出修复候选 Setup 已替换，SHA-256
